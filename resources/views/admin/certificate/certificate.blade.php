                        ...
                        <div class="card-body">
                            <table id="settingTable" class="table table-striped table-bordered nowrap" style="width:100%">
                                ...
                                <tbody id="sortable">
                                    ...
                                    <tr>
                                        <td>
                                            {!! htmlspecialchars_decode($item->cert_name) !!}
                                        </td>
                                        <td class="text-center">
											{{ $item->course->course_title ?? '-' }}
                                        </td>
                                        <td>
                                            <a href="{{ route('certificate.detail', ['id' =>$item->id]) }}" class="btn btn-warning btn-sm"><i class="fas fa-search"></i></a>
                                            <a href="{{ route('certificate.edit',['id' =>$item->id]) }}" class="btn btn-warning btn-sm"><i class="fas fa-pen"></i></a>

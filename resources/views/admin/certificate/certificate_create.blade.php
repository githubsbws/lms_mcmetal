			...
			<div class="container mt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('certificate.create')}}" enctype="multipart/form-data" method="post" id="uploadForm">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="title">ชื่อใบประกาศนียบัตร <span class="required" style="color:red">*</span></label>
                                <input type="text" name="cert_name" class="form-control">
                            </div>

							<div class="form-group">
								<label for="course_picture">ภาพพื้นหลัง</label>

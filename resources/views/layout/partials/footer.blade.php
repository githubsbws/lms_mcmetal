        ...
        <div class="row ">
            ...
            {{-- <div class="col-lg-4">
                ...
                <a href="http://www.histats.com" target="_blank" title="">
                    <script type="text/javascript">
                        try {
                            Histats.start(1, 3337735, 4, 3021, 130, 80, "00011010");
                            Histats.track_hits();
                        } catch (err) {};
                    </script>
            ...
            <div class="col-lg-4">
                ...
                <p>700/426 หมู่ที่ 7 นิคมอุตสาหกรรมบางปะกง เขตอุตสาหกรรมทั่วไป ตำบลดอนหัวฬ่อ อำเภอเมืองชลบุรี จ.ชลบุรี 20000</p>
            </div>
